# 1 "c:\\Users\\joshu\\Documents\\GitHub\\smartwatch\\animation.ino"
/**************************************************************************
 ...
 **************************************************************************/
# 21 "c:\\Users\\joshu\\Documents\\GitHub\\smartwatch\\animation.ino"
# 22 "c:\\Users\\joshu\\Documents\\GitHub\\smartwatch\\animation.ino" 2
# 23 "c:\\Users\\joshu\\Documents\\GitHub\\smartwatch\\animation.ino" 2
# 24 "c:\\Users\\joshu\\Documents\\GitHub\\smartwatch\\animation.ino" 2
# 25 "c:\\Users\\joshu\\Documents\\GitHub\\smartwatch\\animation.ino" 2
...
void setup()
{
 ...
 if (!display.begin(0x02 /*|< Gen. display voltage from 3.3V*/, 0x3C /*	DIYmall 0x3C, Adafruit 0x3D*/))
 {
...
void testdrawstyles(void)
{
 ...
 display.setTextColor(1 /*|< Draw 'on' pixels*/); // Draw white text
 display.setCursor(0, 0); // Start at top-left corner
 display.println(((reinterpret_cast<const __FlashStringHelper *>(("Hello, world!")))));
 ...
 display.print(((reinterpret_cast<const __FlashStringHelper *>(("0x")))));
...
void testscrolltext(void)
{
 ...
 display.println(((reinterpret_cast<const __FlashStringHelper *>(("scroll")))));
...
{
 int8_t f, icons[20 /* Number of snowflakes in the animation example*/][3];

 // Initialize 'snowflake' positions
 for (f = 0; f < 20 /* Number of snowflakes in the animation example*/; f++)
 {
  icons[f][0 /* Indexes into the 'icons' array in function below*/] = random(1 - 16, display.width());
  icons[f][1] = -16;
  icons[f][2] = random(1, 6);
  Serial.print(((reinterpret_cast<const __FlashStringHelper *>(("x: ")))));
  Serial.print(icons[f][0 /* Indexes into the 'icons' array in function below*/], 10);
  Serial.print(((reinterpret_cast<const __FlashStringHelper *>((" y: ")))));
  Serial.print(icons[f][1], 10);
  Serial.print(((reinterpret_cast<const __FlashStringHelper *>((" dy: ")))));
